...
$name1Err = $emailErr = $genderErr = $repeat_emailErr=$passwordErr=$cpasswordErr=$typeErr= "";
$name1 = $email = $gender = $type = $repeat_email=$password=$cpassword = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty($_POST["name1"])) {
   ...
   if (empty($_POST["cpassword"])) {
     $cpasswordErr = " enter password again";
   } else {
     $cpassword = test_input($_POST["cpassword"]);
   }
 /*  if (empty($_POST["name1"])) {
     $name1Err = "no is required";
   } else {
     $name1 = test_input($_POST["name1"]);
   }*/
