...
<div id="tooplate_wrapper">
	...
	<div id="tooplate_sidebar">
		<div id="site_title"><a href="#">MIET<span>GROUP</span></a></div>
        
        <div id="home_service">
        	<div class="home_service_box"><span class="service1"></span><h5><a href="#">Placement</a></h5>Integer sit amet nulla vitae urna porttitor quis et tellus.</div>
    ...
    <div id="tooplate_main">
        ...
        <div id="tooplate_menu">
            <ul>
                <li>
        <a href="add_form.jsp" >ADD STUDENT</a>                
                </li>
                <li><a href="modify.jsp">MODIFY STUDENT</a></li>
                <li><a href="upload_form.jsp">UPLOAD MARKS</a></li>
                <li><a href="displayall.jsp">DISPLAY ALL</a></li>
